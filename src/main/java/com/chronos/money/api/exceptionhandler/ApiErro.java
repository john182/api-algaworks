...
public class ApiErro {
    ...
    private void addValidationError(String objeto, String campo, Object valorRejeitado, String mensagem) {
        addSubError(new ApiValidationErro(objeto, campo, valorRejeitado, message));
    }
    ...
    public List<ApiSubErro> getSubErrors() {
        return subErrors;
    }

    public void setSubErrors(List<ApiSubErro> subErrors) {
